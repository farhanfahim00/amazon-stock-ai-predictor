...
Model Training Script (augmented data version)
...
# Configuration
INPUT_FILE = "Data/AMZN_augmented_data_with_features.csv"
MODEL_DIR = "models/"
RANDOM_STATE = 42
...
joblib.dump(clf_model, MODEL_DIR + "rf_classifier_augmented.joblib")
joblib.dump(rf_5day, MODEL_DIR + "rf_5day_regressor_augmented.joblib")
joblib.dump(rf_1day, MODEL_DIR + "rf_1day_regressor_augmented.joblib")
joblib.dump(ridge_model, MODEL_DIR + "ridge_regressor_augmented.joblib")
